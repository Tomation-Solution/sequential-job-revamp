...
export const get_jobs_applied_for = async ():Promise<getJobAppliedForResponse[]>=>{
...
export const jobsTestTakenApi= async ():Promise<getJobAppliedForResponse[]>=>{
...
export const getInterviewScheduledApi =async ():Promise<InterviewScgeduledResponseType[]>=>{
...
export const jobDasboardSummaryApi  = async():Promise<jobDasboardSummaryApiResponseType>=>{
