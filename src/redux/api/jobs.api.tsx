...
export const get_jobs_api = async ({
  is_active = true,
}: {
  is_active?: boolean;
}): Promise<JobType[]> => {
...
export const applyForJobsApi = async (
  job_id: string
): Promise<applyForJobsResponse> => {
...
export const getCvFilterQuetions = async (
  job_id: string
): Promise<getCvFilterQuetionsResponse> => {
...
export const submitCvFilterQuetions = async ({
  data,
  job_id,
}: Prop): Promise<submitCvFilterQuetionsResponseType> => {
  const senddata: any = {
    job_id: job_id,
    filter_quetion_option: data.filter_quetion_option,
    fill_in_the_gap: data.fill_in_the_gap,
    filter_quetion_multi_choice_quetion:
      data.filter_quetion_multi_choice_quetion,
  };
...
export const submitJobTestQuetion = async ({
  data,
  job_id,
}: Prop): Promise<submitCvFilterQuetionsResponseType> => {
  const senddata: any = {
