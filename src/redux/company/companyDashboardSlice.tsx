...
export type CompanyDashboardSliceStateType = {
  dashboardJobSummaryStatus:
    | "summary-charts"
    | "total_application"
    | "applicants_hired"
    | "total_number_of_job_post"
    | "closed_jobs"
    | "total_number_of_cv"
    | "active_jobs";
};
  ...
  reducers: {
    changeApplicationDashboardState: (
      state,
      {
        ...
        CompanyDashboardSliceStateType["dashboardJobSummaryStatus"]
      >
    ) => {
...
export const selectCompanyDashboard = (state: RootState) =>
  state.CompanyDashboard;
export const { changeApplicationDashboardState } =
